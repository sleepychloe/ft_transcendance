...
<br>
if you do not have an 42 account,
click [here](https://github.com/sleepychloe/ft_transcendance_42Oauth_removed) to git clone instead of cloning from this repository.
